...
public class TempDBMain {
    ...
    public static void main(String[] args) {
        ...
        Company updComp = companyDao.getById(2);
        updComp.setName("Updated");
        companyDao.update(updComp);
        
        for(Company c : companyDao.getList()){
            System.out.println("Lista updated: " + c.getName());
        }
        companyDao.delete(companyDao.getById(2));
        for(Company c : companyDao.getList()){
...
//        Member dspoko = new Member("dspoko", "tempPassword", "dspoko@interia.pl", 22, 11, 2000);
