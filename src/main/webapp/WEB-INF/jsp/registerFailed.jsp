<%-- 
    ...
    Created on : Sep 1, 2014, 8:03:19 AM
    Author     : mkabala
--%>
        ...
        <div id="container">
            ...
            <div id="mainBody">
                <div id="newsContainer" class="mainBody">
                    <h1 class="headline" align="center">Registration failed!</h1>
                    <h2 align="center" color="red"><c:out value="${username}"/> Some random text</h2>
                </div>
